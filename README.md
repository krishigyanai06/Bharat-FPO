...
| `POST` | `/sell/payment-in` | 🔒👔 | Record a customer payment-in receipt |
...
| `DELETE` | `/sell/payment-in/:id` | 🔒👔 | Delete a payment-in receipt |
...
```json
{
  ...
  "date": "2026-06-15",
  "payments": [
    { "paymentType": "UPI", "amount": 3500, "referenceNo": "TXN123456-UPDATED" }
  ],
  "paidAmount": 3500,
