...
export default function Party() {
    ...
    const { parties, loading, error } = useSelector((s) => s.party);
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {loading && parties.length === 0 ? (
                    ...
                    Array(4).fill(0).map((_, idx) => (
                        <div key={idx} className="bg-white border border-gray-200 rounded-xl px-4 py-3 h-[90px] shadow-xs flex items-center justify-between animate-pulse">
                    ...
                    [
                        { label: "Total Parties", val: totals.total, icon: Users, bg: "bg-blue-50 text-blue-700 border-blue-100" },
