...
const Dashboard = () => {
  ...
  return (
    <div className="space-y-6 w-full min-h-[80vh] bg-white rounded-2xl p-6 border border-gray-150 select-none">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          ...
          <div className="bg-white rounded-xl border border-gray-150 p-5 flex flex-col justify-between h-[165px] hover:shadow-md transition-all">
            ...
            <div className="flex items-center justify-between border-t border-gray-50 pt-2.5">
              <button 
                onClick={() => navigate('/gst-reports/gstr-1')}
                className="text-[#15803D] font-bold text-xs hover:underline cursor-pointer"
              >
                Open Report
              </button>
              <ArrowRight onClick={() => navigate('/gst-reports/gstr-1')} className="w-4 h-4 text-[#15803D] cursor-pointer" />
            </div>
          </div>
